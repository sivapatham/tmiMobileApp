...
public class HomeQuoteDetailsActual extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText text = (EditText) findViewById(R.id.idv);
        EditText ed_ssn = (EditText) findViewById(R.id.SSN_aadhar);
    ...
    public void getHomeQuote(View v){
        ...
        EditText et_cons_year = (EditText)findViewById(R.id.const_year);
        homeYear = et_cons_year.getText().toString();
        Log.d("Home Year",homeYear);
        if(homeYear.matches("")){
            Toast.makeText(HomeQuoteDetailsActual.this, "Please enter Home year", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        if(s_ct != null && s_ct.getSelectedItem() != null && !(s_ct.getSelectedItem().toString().equals("--Select--"))){
            construction_type = (String)s_ct.getSelectedItem();
            Log.d("Construction type",construction_type);
        }else{
            Toast.makeText(HomeQuoteDetailsActual.this, "Please select construction type", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        if(address.matches("")){
            Toast.makeText(HomeQuoteDetailsActual.this, "Please enter Home address", Toast.LENGTH_SHORT).show();
            return;
        }
        EditText et_city = (EditText)findViewById(R.id.city);
        city = et_city.getText().toString();
        Log.d("City",city);
        if(city.matches("")){
            Toast.makeText(HomeQuoteDetailsActual.this, "Please enter Home City", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        Log.d("State",state);
        if(state.matches("")){
            Toast.makeText(HomeQuoteDetailsActual.this, "Please enter Home State", Toast.LENGTH_SHORT).show();
            return;
        }

        EditText et_zip = (EditText)findViewById(R.id.zip_code);
        zip = et_zip.getText().toString();
        if(zip.matches("")){
            Toast.makeText(HomeQuoteDetailsActual.this, "Please enter zip code", Toast.LENGTH_SHORT).show();
            return;
        }
        Log.d("ZIP",zip);


        EditText et_idv = (EditText)findViewById(R.id.idv);
        coverage_val = et_idv.getText().toString();
        Log.d("Coverage",coverage_val);
        if(coverage_val.matches("")){
            Toast.makeText(HomeQuoteDetailsActual.this, "Please enter Coverage val", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        if(ed_ssn.getVisibility()==View.VISIBLE){
            ...
            Log.d("aadhar",aadhar);
            if(aadhar.matches("")){
                Toast.makeText(HomeQuoteDetailsActual.this, "Please enter Aadhar/SSN value", Toast.LENGTH_SHORT).show();
                return;
            }
                    ...
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            if(!loggedIn)
                                ...
                                Intent intent;
                                intent = new Intent(HomeQuoteDetailsActual.this, HomeActivity.class);
    ...
    public void showDialog(String msg,String btn_name) {
        this.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                AlertDialog.Builder builder = new AlertDialog.Builder(HomeQuoteDetailsActual.this);
                ...
                builder.setTitle("TrustMeInsurance")
                        ...
                        .setPositiveButton(btn_name, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                Intent resultIntent = new Intent(HomeQuoteDetailsActual.this,MainActivity.class);
