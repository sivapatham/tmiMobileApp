...
public class CarQuoteDetails extends AppCompatActivity {
    ...
    public void getCarQuote(View v){
       ...
       if(s_make != null && s_make.getSelectedItem() != null && !(s_make.getSelectedItem().toString().equals("None"))){
           ...
           Toast.makeText(CarQuoteDetails.this, "Please select car Make", Toast.LENGTH_SHORT).show();
           return;
       }
        ...
        if(s_model != null && s_model.getSelectedItem() != null && !(s_model.getSelectedItem().toString().equals("None"))){
            ...
            Toast.makeText(CarQuoteDetails.this, "Please select car Model", Toast.LENGTH_SHORT).show();
            return;
        }


        TextInputLayout et_car_year1 = (TextInputLayout)findViewById(R.id.TILCarYear);
        TextInputEditText et_car_year = (TextInputEditText) et_car_year1.getEditText();
        carYear = et_car_year.getText().toString();
        Log.d("Car Year",carYear);
        if(carYear.matches("")){
            Toast.makeText(CarQuoteDetails.this, "Please enter Car year", Toast.LENGTH_SHORT).show();
            return;
        }
                    ...
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            if(!loggedIn)
                                ...
                                Intent intent;
                                intent = new Intent(CarQuoteDetails.this, HomeActivity.class);
    ...
    public void showDialog(String msg,String btn_name) {
        this.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                AlertDialog.Builder builder = new AlertDialog.Builder(CarQuoteDetails.this);
                ...
                builder.setTitle("TrustMeInsurance")
                        ...
                        .setPositiveButton(btn_name, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                Intent resultIntent = new Intent(CarQuoteDetails.this,MainActivity.class);
